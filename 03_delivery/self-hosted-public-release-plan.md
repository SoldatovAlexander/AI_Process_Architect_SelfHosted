...
Статус: архивный план ранней коммерческой self-hosted поставки. Он сохранён как история, но не
определяет текущий Community-релиз: Community работает без лицензии, открывает все рабочие режимы и
разрешает только BPMN/draw.io и текстовое описание процесса в пользовательском экспорте.
